...
@section('content')
                ...
                <div class="col-md-10">
                    <div class="contents text-center">
                        <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Informatics
                            Photography Competition</h1>
                        <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms"><em>"Human
                                InTerest"</em></p>
                        @if(Auth::guest())
    ...
    <section id="blog" class="section">
        ...
        <div class="container">
            <div class="row">
                <div data-configid="30951858/52737447" style="width:100%; height:1000px;" class="issuuembed"></div>
